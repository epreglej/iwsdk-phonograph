...
// import { Grabbed } from "../utils/grab.js";
...
// // Highly complex logic for overriding the default GrabSystem (by using a pivot entity)
// export class CrankSystem extends createSystem(
//   {
//     activeCrankDescriptionTask: {
//       required: [Task, ActiveTask],
//       excluded: [CompletedTask],
//       where: [eq(Task, "id", "crank_description")],
//     },
...
//       this.queries.activeCrankDescriptionTask.subscribe("qualify", () => {
//         crankEntity.addComponent(PopIn);
//         crankEntity.object3D!.visible = true;
//       }),
...
//         // Create a visual pivot child which WE rotate manually
...
//       // IMPORTANT:
//       // Calculate using ROOT but rotate PIVOT
